...
public class Chunk_zTXt extends Chunk {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Chunk_zTXt.class);
    ...
    // Constructors
    // -------------------------------------------------------------------------------------
    public Chunk_zTXt(final int intSeq, final int intLen, final byte[] bytType, byte[] bytData, int intCrc,
