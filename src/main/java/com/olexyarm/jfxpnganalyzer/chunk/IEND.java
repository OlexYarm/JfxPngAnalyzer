...
// PNG chunk IEND Image end

    // -------------------------------------------------------------------------------------
    // Constructors
    // -------------------------------------------------------------------------------------
    public IEND(final int intChunkSeq, final int intChunkLen, final byte[] bytType,
            byte[] bytChunkData, int intChunkCrc, ObservableMap<String, Chunk> omapChunks) { //throws IOException {
